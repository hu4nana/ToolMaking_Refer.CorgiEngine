...
public class Character : MonoBehaviour
{
    ...
    public virtual void UpdateAnimators()
    {
        if (ani != null &&
            _curConditionState == CharacterStatements.ConditionStatement.Normal &&
            _curActionState != CharacterStatements.ActionStatement.NormalAttack &&
            _curActionState != CharacterStatements.ActionStatement.Death &&
            _curActionState != CharacterStatements.ActionStatement.Casting1 &&
            _curActionState != CharacterStatements.ActionStatement.Casting2 &&
            _curActionState != CharacterStatements.ActionStatement.Casting3 &&
            _curActionState != CharacterStatements.ActionStatement.Casting4 &&
            !isGrounded)
            ActionState.ChangeState(CharacterStatements.ActionStatement.Jump);
        ...
        if (ani != null &&
            ...
            _curActionState != CharacterStatements.ActionStatement.Casting3 &&
            _curActionState != CharacterStatements.ActionStatement.Casting4 &&
            _curActionState != CharacterStatements.ActionStatement.Jump &&
            Input_Horizontal == 0)
            ActionState.ChangeState(CharacterStatements.ActionStatement.Idle);
